...
//! card listing all thread actions, anchored at the three-dot button.
//! Reads state from `Inboxly`:
//! - `overflow_menu_thread`: `Option<String>` — when `Some`, the menu is visible
//! - `overflow_menu_position`: `Point` — where the button was clicked
    ...
    rsx! {
        ...
        div {
            ...
            onclick: move |evt: Event<MouseData>| {
                ...
                app_state.write().update(Message::CloseOverflowMenu);
            },
